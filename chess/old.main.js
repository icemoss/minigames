...
class ChessGame {
  ...
  evaluateBoard() {
    ...
    evaluation += (Math.random() - 0.5) * this.randomisationConstant;
    return evaluation;
  }
  ...
  findBestMove(color) {
    ...
    for (const move of allPossibleMoves) {
      ...
      if (opponentMoves.length === 0) {
        ...
        // Calculate worst case scenario for the AI.
        // Find the best evaluation for the opponent.
